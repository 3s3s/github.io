...
{
	adNetworks: [
		{host: "ad.a-ads.com", code: "<iframe data-aa='47233' target='_blank' src='//ad.a-ads.com/47233?size=468x60' scrolling='no' style='width:468px; height:60px; border:0px; padding:0;overflow:hidden' allowtransparency='true'></iframe>"},
		{host: "ad.a-ads.com", code: "<iframe data-aa='48086' src='//ad.a-ads.com/48086?size=468x60' scrolling='no' style='width:468px; height:60px; border:0px; padding:0;overflow:hidden' allowtransparency='true'></iframe>"},
...
//		{host: "rcm-na.amazon-adsystem.com", code: '<iframe target="_blank" src="http://rcm-na.amazon-adsystem.com/e/cm?t=3sstsasu-20&o=1&p=26&l=ur1&category=mp3&f=ifr&linkID=PXPMMJQRPMRFCEKG" width="468" height="60" scrolling="no" border="0" marginwidth="0" style="border:none;" frameborder="0"></iframe>'},
		{host: "ad.3s3s.org", code: "<iframe target='_blank' src='http://ad.3s3s.org' scrolling='no' style='width:468px; height:60px; border:0px; padding:0;overflow:hidden' allowtransparency='true'></iframe>"}
		...
		function onLoad()
		{
			...
			parent.innerHTML = 
				"<table style='width: 100% !important; height: 100% !important'><tr style='vertical-align: center !important'>" +
					"<td style='valign: top !important'><span style='color: #005689 !important; cursor: pointer !important;' id='_3s3sCloseAd' title='close ad'>close</span></td>" +
					"<td style='width: 100% !important; height: 100% !important; text-align: center !important'>" +
					_3s3sObject.adNetworks[nIndex].code + "</td>"+
					"<td><a style='color: #005689 !important;' href='mailto:ivanivanovkzv@gmail.com?subject=Offer of cooperation (AD 3s3s.org)'>Advertise on 3s3s.org</a></td>"+
				"</tr></table>";
